...
function CopybookEditor({ config, onConfigChange, selectedTemplateId: propSelectedTemplateId, onTemplateIdChange }) {
  ...
  const getStrokeOrderText = useCallback((character) => {
    ...
    const strokesMap = {
      ...
      '美': ['点', '撇', '横', '横', '竖', '横', '横', '撇', '捺'],
      '丑': ['横折', '竖', '横', '横'],
      '善': ['点', '撇', '横', '横', '横', '竖', '点', '撇', '横', '竖', '横折', '横'],
      '恶': ['横', '竖', '竖', '横折', '横', '撇', '点', '竖弯钩', '点', '点', '点'],
      '真': ['横', '竖', '竖', '横折', '横', '横', '横', '横', '撇', '点'],
      '假': ['撇', '竖', '横折', '横', '竖', '横', '横', '横折', '横', '横', '撇', '捺'],
      '新': ['点', '横', '点', '撇', '横', '横', '竖钩', '撇', '点', '撇', '撇', '横', '竖'],
      '旧': ['竖', '竖', '横折', '横', '横'],
      '快': ['点', '点', '竖', '横折', '横', '撇', '捺'],
      '慢': ['点', '点', '竖', '竖', '横折', '横', '横', '竖', '横折', '横', '横'],
      '长': ['撇', '横', '竖提', '捺'],
      '短': ['撇', '横', '横', '撇', '点', '横', '竖', '横折', '横', '横'],
      '高': ['点', '横', '竖', '横折', '横', '竖', '横折钩', '竖', '横折', '横'],
      '低': ['撇', '竖', '撇', '竖提', '横', '斜钩', '点'],
      '宽': ['点', '点', '横撇', '竖', '竖', '竖', '横折', '撇', '竖弯钩'],
      '窄': ['点', '点', '横撇', '撇', '点', '撇', '横', '竖', '横折', '横', '横'],
      '远': ['横', '横', '撇', '竖弯钩', '点', '横折折撇', '捺'],
      '近': ['撇', '撇', '横', '竖', '横折', '横', '点', '横折折撇', '捺'],
      '轻': ['横', '撇折', '竖提', '横撇', '点', '横', '竖', '横折', '横'],
      ...
      '非': ['竖', '横', '横', '横', '竖', '横', '横', '横'],
      '能': ['撇折', '点', '竖', '横折钩', '横', '横', '撇折', '点', '撇', '竖弯钩'],
      '会': ['撇', '捺', '横', '横', '撇折', '点'],
      '可': ['横', '竖', '横折', '横', '竖钩'],
      '否': ['横', '撇', '竖', '点', '竖', '横折', '横'],
      '爱': ['撇', '点', '点', '撇', '点', '横撇', '横撇', '捺'],
      '恨': ['点', '点', '竖', '横折', '横', '横', '竖提', '撇', '捺'],
      '想': ['横', '竖', '撇', '点', '竖', '横折', '横', '横', '横', '点', '斜钩', '点', '点'],
      '念': ['撇', '捺', '点', '横撇', '点', '斜钩', '点', '点'],
      '思': ['竖', '横折', '横', '竖', '横', '点', '斜钩', '点', '点'],
      '意': ['点', '横', '点', '撇', '横', '竖', '横折', '横', '横', '点', '斜钩', '点', '点'],
      '情': ['点', '点', '竖', '横', '横', '竖', '横折', '横', '横'],
      '感': ['横', '撇', '横', '竖', '横折', '横', '斜钩', '撇', '点', '点', '点', '点'],
      '理': ['横', '横', '竖', '提', '竖', '横折', '横', '横', '竖', '横', '横'],
      '智': ['撇', '横', '横', '撇', '点', '竖', '横折', '横', '横', '竖', '横折', '横'],
      '勇': ['横撇', '点', '竖', '横折', '横', '横', '横折钩', '撇'],
      '敢': ['横折折折钩', '横', '竖', '竖', '横', '横', '横', '撇', '捺'],
      '怕': ['点', '点', '竖', '撇', '竖', '横折', '横', '横'],
      '惊': ['点', '点', '竖', '横', '竖', '竖', '横折', '横', '竖钩', '点', '点'],
      '喜': ['横', '竖', '横折', '横', '点', '撇', '横', '竖', '横折', '横'],
      '怒': ['撇点', '撇', '横', '横撇', '捺', '点', '卧钩', '点', '点'],
      '哀': ['点', '横', '竖', '横折', '横', '撇', '竖提', '撇', '捺'],
      '乐': ['撇', '竖折', '竖钩', '撇', '点'],
      '愁': ['撇', '横', '竖', '撇', '点', '竖', '横折', '横', '横', '点', '斜钩', '点', '点'],
      '苦': ['横', '竖', '竖', '横', '竖', '竖', '横折', '横'],
      '甜': ['撇', '横', '竖', '竖', '横折', '横', '横', '横', '竖', '竖', '横折', '横'],
      '酸': ['横', '竖', '横折', '横', '横', '撇折', '点', '撇', '点', '撇', '横撇', '捺'],
      '辣': ['点', '横', '点', '撇', '横', '横', '竖钩', '撇', '点', '横', '竖', '横折', '横', '竖', '撇', '捺'],
      '咸': ['横', '撇', '横', '竖', '横折', '横', '斜钩', '撇', '点'],
      '香': ['撇', '横', '竖', '撇', '捺', '竖', '横折', '横', '横'],
      '臭': ['撇', '竖', '横折', '横', '横', '横', '撇', '捺', '点'],
      '软': ['横', '撇折', '竖提', '撇', '横撇', '撇', '捺'],
      '硬': ['横', '撇折', '竖提', '横', '竖', '横折', '横', '横', '撇', '捺'],
      '冷': ['点', '提', '撇', '捺', '点', '横撇', '点'],
      '热': ['横', '竖钩', '提', '撇', '横折弯钩', '点', '点', '点', '点'],
      '温': ['点', '点', '提', '竖', '横折', '横', '横', '竖', '横折', '竖', '竖', '横'],
      '凉': ['点', '提', '点', '横', '竖', '横折', '横', '竖钩', '撇', '点'],
      '清': ['点', '点', '提', '横', '横', '竖', '横折钩', '横', '横'],
      '浊': ['点', '点', '提', '竖', '横折', '横', '竖', '横', '点'],
      '静': ['横', '横', '竖', '横', '竖', '横折钩', '横', '横', '撇', '横撇', '横折钩', '横', '横'],
      '动': ['横', '横', '撇折', '点', '横折钩', '撇'],
      '空': ['点', '点', '横撇', '撇', '点', '横', '竖', '横'],
      '满': ['点', '点', '提', '横', '竖', '竖', '横', '竖', '横折钩', '撇', '点', '撇', '点'],
      '盈': ['横撇弯钩', '撇', '横折钩', '点', '竖', '横折', '竖', '竖', '横'],
      '亏': ['横', '横', '竖折折钩'],
      '增': ['横', '竖', '横', '竖', '横折', '横', '横', '竖', '横折', '横', '横'],
      '减': ['点', '提', '横', '撇', '横', '竖', '横折', '横', '斜钩', '撇', '点'],
      '乘': ['撇', '横', '竖', '竖', '横', '横', '撇', '竖弯钩', '撇', '点'],
      '除': ['横折折折钩', '竖', '撇', '捺', '横', '横', '竖钩', '撇', '点'],
      '加': ['横折钩', '撇', '竖', '横折', '横'],
      ...
      '兆': ['撇', '点', '提', '竖弯钩', '撇', '点'],
      '京': ['点', '横', '竖', '横折', '横', '竖钩', '撇', '点'],
      '垓': ['横', '竖', '横', '撇', '点', '点', '横', '撇折', '撇', '点'],
      '秭': ['撇', '横', '竖', '撇', '点', '撇', '竖提', '撇'],
      '穰': ['撇', '横', '竖', '撇', '点', '点', '横', '竖', '横折', '横', '横', '横折', '撇', '点', '竖提', '撇', '捺'],
      '沟': ['点', '点', '提', '撇', '横折钩', '撇', '点', '点', '竖'],
      '涧': ['点', '点', '提', '点', '竖', '横折钩', '竖', '横折', '横', '横'],
      '正': ['横', '竖', '横', '竖', '横'],
